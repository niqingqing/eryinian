...
<template>
	<view class="popup_list" >
		<view v-for="(items,index) of popup_list" :id="items.uuid" :key="items.uuid" style="">
			...
			<view style="width: 100vw;height: 100vh;background:rgba(0,0,0,0.5);position: fixed;left: 0;top: 0;"></view>
		</view>
	</view>
</template>
