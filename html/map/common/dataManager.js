                ...
                $.ajax({
                    ...
                    success: function(json){
                        ...
                        if (func) {
                            ...
                            if(currentMap&&currentMap.cfgMap){
                                var cfgMapArr = JSON.parse(currentMap.cfgMap);
                                for(var i=0;i<cfgMapArr.length;i++){
                                    if(cfgMapArr[i].key == "cfg_webMap_showAllTag"){
                                        ME.vm.switchData.cfg_webMap_showAllTag = cfgMapArr[i].value*1;
                                    }
                                }
                            }
                        }
            ...
            loadNodes: function (mapId, $this, func, convertFunc) {
                $.ajax({
                    ...
                    success: function(json){
                        ...
                        if(ME.vm.switchData.cfg_webMap_showAllTag) {
                            ME.vm.switchData.isShowActiveTag = false;
