...
var vue_data_source = function vue_data_source() {
    ...
    return _ref = {
        ...
        polygonPoints:[], //围栏坐标，用于修改时记录。
        editLastFenceId:null,//最后一次隐藏的围栏。
        fenceDrawing:null,//画的临时围栏。
        fenceMovePoints:[],//围栏要移动的顶点
        clickPolygonPtNum:undefined,//要修改的围栏坐标的位置。
        clickPolygonFlag:false, //是否正在修改一个围栏的坐标。
        allPoints:{
            fence:[],      //存放绘制时所有点
            tempfence:[],  //存放绘制时直线两点
            tempcamera:[],
        ...
        // 编辑或者添加围栏有效期的时候使用
        baseFenceValidities: [],
        farthestDistanceShow: false,  // 是否提示
        farthestDistanceData: 0 // 框选区域统计得到的最远距离
    },
        ...
        powerAuto: false,
        setOrigin:false,
        dblclickAnchor:false,
        hideMap:false,
        cfg_webMap_showAllTag:0,
        isShowTagTypes:[],
        isShowTagCats:[],
        ...
        _defineProperty(_ref, 'tag', {
            onlineData:[], //后期二次开发, 添加的变量 所有在线标签
            data: [],
            get sirens(){
                if(this.data.length < 1){
                    return [];
        ...
        _defineProperty(_ref, 'fence', {
            ...
            {
                id: 'inStop',
                cname: lang['triggeringInnerStop']
            },
        ],
