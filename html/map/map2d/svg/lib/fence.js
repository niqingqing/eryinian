    ...
    return initialize = function initialize(a) {
        ...
        if(key=='fence'){
            c += "<tr><td>"+lang['fenceId']+"</td><td>" + a.id + "</td></tr>", c += "<tr><td>"+lang['fenceName']+"</td><td>" + a.cname + "</td></tr>", c += "<tr><td>"+lang['fenceType']+"</td><td>" + a.ftype + "</td></tr>",
                c += "<tr><td>"+lang['warningCondition']+"</td><td>" + (a.trif == 'i' ? lang['triggeringIn'] : a.trif == 'o' ? lang['triggeringOut'] : (a.trif == 'in' ? '内部触发' :(a.trif == 'inStop' ? lang['triggeringInnerStop']: lang['triggeringInOut']))) + "</td></tr>";
        ...
        if(data.polygonPoints&&data.polygonPoints.length>0){
            fence.polygonPoints = data.polygonPoints;
            fence.fenceDrawing.set('path', fence.polygonPoints);
        }
        if (fenceType) {
