...
function pageInit(){
    ...
    $('#gpsVitalLogtable').bootstrapTable({
        url:ME.host+'/gpsVitalLog/list',
        method:'get',
        ...
        toolbarAlign:'left',
        toolbar:'#gpsVitaltoolbar',
    columns: [
        // {field: 'id',title: 'ID', width:'4%', sortable:true, searchable:true},
        {field: 'tag',title: '标签',width:'10%', sortable:true,searchable:true},
        {field: 'hr',title: '心率',width:'10%', sortable:true, searchable:true},
        {field: 'temp',title: '体温',width:'10%', sortable:true, searchable:true},
        {field: 'bp',title: '血压',width:'6%', sortable:true, searchable:true},
        
        {field: 'timestamp',title: '记录时间',width:'20%', sortable:true, searchable:true,
        ...
        methods:{
            ...
            clearTable:function(){
                ...
                this.$confirm("确认清除掉所有的原始数据么？","提示",{ }).then(function() {
                    ...
                    var tag = form.tag;
                    var url = ME.host+'/gpsVitalLog/clearTable?tag=' + tag + '&start=' + start + '&end=' + end;
            ...
            refresh:function(){
                $('#gpsVitalLogtable').bootstrapTable('refresh');
            },
