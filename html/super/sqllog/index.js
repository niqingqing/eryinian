...
function pageInit(){
    ...
    columns: [
        ...
        {field: 'userCode',title: lang['operateUser'],width:'6%', sortable:true, searchable:true},
        {field: 'time',title: lang['addTime'],width:'6%', sortable:true, searchable:true,
            formatter:function(value, row, index){
                var date = new Date(value);
                return date.toLocaleString();
            }
        },
        {field: 'sql',title: lang['content'], width:'30%', sortable:true, searchable:true},
    ]
        ...
        methods:{
            ...
            clearTable:function(){
                ...
                this.$confirm(lang['clearTableNote'],lang['prompt'],{ }).then(function() {
                    ...
                    var url = ME.host+'/sqllog/clearTable?start=' + self.searchform.timespan[0] + '&end=' + self.searchform.timespan[1];
