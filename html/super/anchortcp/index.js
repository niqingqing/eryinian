...
function pageInit(){
    ...
    $('#heartRateLogtable').bootstrapTable({
        ...
        queryParams:function(params){
            ...
            params.mac=searchParams.mac || '';
            // if(searchParams.mapId>0) params.map = ME.user.projectCode+'_'+searchParams.mapId;
            params.mapId = searchParams.mapId||'';
            params.projectCode = searchParams.projectCode||'';
            return params;
        },
        search:true,
        showRefresh:true,
    ...
    columns: [
        ...
        {field: 'projectCode',title: '项目编码',width:'10%', sortable:true,searchable:true},

        {field: 'mapId',title: '地图id',width:'16%', sortable:true, searchable:true},
        {field: 'mac',title: '基站',width:'10%', sortable:true, searchable:true},
