...
//根据开发模式不同拼接不同的地址参数
const hostIp = devMode ? '60.209.39.19:8762': window.location.host;
const hostIpUrlPrefix = devMode ? hostIp : hostIp + '/api';     //接口访问前缀开发版的地址没有/api前缀,而正式环境接的没有前缀
const websocketHost = devMode ? '60.209.39.19:8763' : hostIp;   //配置websocket请求地址
// const extendHostIp = 'http://127.0.0.1:8080';     //扩展平台地址
const extendHostIp = devMode ? 'http://127.0.0.1:8080' : 'http://172.16.16.77:8080';     //扩展平台地址
const extendHostUrl = extendHostIp + '/api';     //扩展平台地址


const  wasteCarTypeIds = [9, 15];   //医废车类型id(标签类型),9是小推车(目前来看好多医废车都是用的这个类型),15是医废车
const  specimenTypeIds = [16];   //标本箱类型id(标签类型)
...
var UBIT = {
        ...
        cameraWsUrl:document.location.protocol === 'https:'? 'wss://'+hostIp+':48084': 'ws://'+hostName+':8088',

        host:document.location.protocol === 'https:'? 'https://'+hostIp+':48082' : 'http://'+hostIpUrlPrefix,
        websocketUrl: document.location.protocol === 'https:'? 'wss://'+hostIp+':48083': 'ws://'+websocketHost,
        // cameraWsUrl:document.location.protocol === 'https:'? 'wss://'+hostIp+':48084': 'ws://'+hostIp+'/cameraws',
        imgHost: 'http://'+hostIpUrlPrefix+'/file/getFile?fileName=',

        version:'ubi_v2.4.8',
        footer:'北京全迹科技版权所有2021，技术支持：support@ubitraq.com',
        versionTag:'v2.4.8',
        user:null,
        api_token:null,
        isSuper: false,
        ...
        txPowers:['c0c0c0c0','07274767','0d072747','130d0727', 'a1a1a1a1',
          'a7a7a7a7', '88888888', '8f8f8f8f', '70707070', '50505050',
          '57575757', '38383838', '3e3e3e3e', '1f1f1f1f'],
